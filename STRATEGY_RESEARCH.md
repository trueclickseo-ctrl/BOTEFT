...
| Regime-aware cross-sectional ranking v1 | Rank ETFs by 60-day momentum, SPY-relative strength, and volatility penalty; only when SPY trend is positive | Portfolio-level backtester implemented; evaluation pending | Research only | Run across synced universe with turnover costs before comparison. |
