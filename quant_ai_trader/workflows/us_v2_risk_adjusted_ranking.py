"""One-variable v2 test: raw versus risk-adjusted 252-day momentum ranking."""
...
def run():
    ...
    output = {}
    for name, adjusted in (("raw_momentum_baseline", False), ("risk_adjusted_momentum", True)):
        curve, decisions, metrics = _evaluate(bars, adjusted)
        _, _, stress = _evaluate(bars, adjusted, stress=True)
