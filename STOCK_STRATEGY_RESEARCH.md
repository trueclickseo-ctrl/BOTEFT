...
| 2026-08-07 | Frozen dependent-return robustness audit | 2,000 stationary-bootstrap paths per candidate; 20-session expected block; canonical net-of-cost daily returns; 95% required joint probability of Sharpe >=0.75, drawdown >=-15%, and positive return | Joint probabilities: DJIA-30 core-satellite 81.30%; Nasdaq-100 momentum 40.35%; S&P Top-50 momentum 40.85%. All fifth-percentile total returns stayed positive, but fifth-percentile drawdowns were -18.87%, -24.60%, and -23.79%. | Rejected | No candidate clears the preregistered 95% robustness gate. Drawdown uncertainty is the dominant blocker. Bootstrap evidence has no authority to approve paper orders. |
